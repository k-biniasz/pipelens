...
export default function App(){
  ...
  const runReengageAnalysis = async () => {
    ...
    try {
      ...
      const prompt = inputBlock+"\n\nYou are given a list of non-converted "+(accountCol?"accounts":"leads")+". Your job is to go through EVERY SINGLE ONE and assign it a re-engagement priority rating. Do not skip any. Do not summarize or group them — list each one individually.\n\nProvide:\n## 1. Complete Account Re-engagement List\nFor EVERY account in the input data above, output one line in this exact format:\n**[Account Name]** | Priority: High/Medium/Low/Skip | Reason: [1 sentence] | Approach: [Ads / SDR / Both]\n\nDo not omit any account. If you are unsure, default to Low rather than skipping it.\n\n## 2. Re-engagement Signal Patterns\nWhat note patterns or profile signals most strongly indicate a good account to re-target. Max 6 bullets.\n\n## 3. "
      +(accountCol ? "Persona Gap Hypothesis\nFor the High-priority accounts, what type of person should we reach next instead — different title, seniority, or function?\n\n## 4. " : "")
      +"Recommended Re-engagement Message Themes\nTop 4 message angles to use in ads or SDR outreach.";
